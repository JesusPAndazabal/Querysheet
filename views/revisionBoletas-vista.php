...
<div class="callout callout-warning">
  <h3 class="text-center">Boletas por Revisar<i class="fas fa-check-circle ml-2"></i></h3>
</div>
...
<!-- Columna que contiene el filtro de busqueda para la consulta de boletas -->
  ...
  <ol class="breadcrumb float-sm bg-light" style = "font-size:15px;">
    <li class="breadcrumb-item active" aria-current="page"><a href = "main.php?view=consultaboletas-vista">Boletas Registradas</a></li>
    <li class="breadcrumb-item active" aria-current="page" >Boletas por Revisar</li>
  </ol>

    
<!-- Filtros para la busqueda del empleado -->
  ...
  <div class="modal-dialog modal-xl modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header bg-success">
        <h5 class="modal-title" id="staticBackdropLabel">Formulario de Registro de remuneraciòn</h5>
    ...
    <div class="modal-content">
      ...
      <h6 class="text-bold">Detalle de Responsables : </h6>
        ...
        <div class="row mt-3">
            ...
            <div class="col-md-2">
                    <label for="" class="text-truncate">Monto Imponible :</label>
...
<!-- Script -->
<script src="dist/js/other/boletasRevisar.js"></script>