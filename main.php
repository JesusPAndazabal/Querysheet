  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar" >
      ...
      <nav class="mt-3">
        ...
        <h5 class="text-center text-white mb-5 text-bold">Rol : <?= $_SESSION['nivelacceso'];?></h5>
              ...
              <li class='nav-header'>MENU</li>
                <li class='nav-item'>
                    ...
                    <i class="nav-icon fas fa-file-archive"></i>
                      ...
                      <li class='nav-item'>
                        <a href='main.php?view=consultaboletas-vista' class='nav-link' style="color:white">
                      ...
                      <?php
                        if($_SESSION['nivelacceso'] == "Administrador"){
                            echo "
                              <li class='nav-item'>
                                <a href='main.php?view=revisionBoletas-vista' class='nav-link' style='color:white'>
                          ...
                          echo "
                          <li class='nav-item'>
                            <a href='main.php?view=revisionBoletasEmpleado-vista' class='nav-link' style='color:white'>
                              <i class='fas fa-check nav-icon'></i>
                              <p>Boletas Observadas</p>
                            </a>
                          </li>
                        ";
                        }
                ...
                <li class='nav-header'>MANTENIMIENTO</li>
                          <li class='nav-item'>
                            <a href='main.php?view=instituciones-vista' class='nav-link' style="color:white">
                              <i class="fas fa-school nav-icon"></i>
                              <p>Instituciones</p>
                            </a>
                          </li>
                          <li class='nav-item'>
                            <a href='main.php?view=empleados-vista' class='nav-link' style="color:white">
                          ...
                          if($_SESSION['nivelacceso'] == "Administrador"){
                              echo "
                              <li class='nav-item'>
                                <a href='main.php?view=adminUsuarios' class='nav-link' style='color:white'>
